...
> *Calculate the perfect seat distribution for your movies - one week at a time*
...
**Hollywood Animals Master** helps players of [**Hollywood Animal**](https://store.steampowered.com/app/2680550/Hollywood_Animal/) calculate the optimal theater seat distribution for their movies.

When releasing a movie in Hollywood Animal, you need to decide how many seats to buy each week. This tool does the complex math instantly, showing you exactly how many seats to purchase week-by-week based on your movie's Commercial Score and your total seat budget.

<p align="center">
  <img src="docs/images/calculator-demo.gif" alt="Calculator Demo" width="700"/>
</p>
...
|----------|----------|------|
| 🖥️ **Windows** | `hollywood-animals-master-*-windows-x64.zip` | ~50 MB |
| 🍎 **macOS** | `hollywood-animals-master-*-macos-x64.zip` | ~50 MB |
| 🐧 **Linux** | `hollywood-animals-master-*-linux-x64.zip` | ~50 MB |
| 🤖 **Android** | `hollywood-animals-master-*-release.apk` | ~20 MB |
...
### 🧮 Smart Calculator
- ⚡ Instant seat distribution calculations
...
<details>
<summary><b>🎨 View Theme Gallery</b></summary>

<table>
  <tr>
    <td align="center">
      <img src="docs/images/theme-hollywood-classic-dark.png" width="350" alt="Hollywood Classic"/>
      <br><b>Hollywood Classic (Dark)</b>
    </td>
    <td align="center">
      <img src="docs/images/theme-midnight-purple-dark.png" width="350" alt="Midnight Purple"/>
      <br><b>Midnight Purple (Dark)</b>
    </td>
  </tr>
</table>
...
4. Enter **Number of Seats** (your total distribution budget)

<table>
  <tr>
    <td width="50%">
      <img src="docs/images/screenshot-parameters.png" alt="Enter Parameters"/>
      <br><em>Step 1: Input your movie's data</em>
    </td>
    <td width="50%">
      <img src="docs/images/screenshot-results.png" alt="View Results"/>
      <br><em>Step 2: See week-by-week breakdown</em>
    </td>
  </tr>
</table>
...
Click **Calculate** to see your week-by-week seat distribution:
- Week 1: 1,250 seats
- Week 2: 980 seats
- Week 3: 750 seats
- And so on...
...
<p align="center">
  <img src="docs/images/screenshot-saved-movies.png" alt="Saved Movies" width="600"/>
  <br><em>Manage all your calculations in one place</em>
</p>
